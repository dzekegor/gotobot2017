...
## Примечание к списку
Пользователи, попытавшиеся при запросе удалить БД или отдельные таблицы, будут занесены в таблицу gady, в которую вы сможете заглядывать время от времени. Надеюсь, это не потребуется, но небольшая паранойя не помешает.
